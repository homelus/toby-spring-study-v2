...
import jun.spring.etc.ioc.POJO.Customer;
import jun.spring.etc.ioc.POJO.Deal;
...
public class CH_1_2_2_REGISTER_BEAN {
    ...
    public void XML_이용하는_컨텍스트_테스트() {
        GenericApplicationContext ac = new GenericXmlApplicationContext("/etc/xmlRegisterApplicationContext.xml");
