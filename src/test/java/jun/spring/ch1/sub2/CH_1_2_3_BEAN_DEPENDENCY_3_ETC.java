...
import jun.spring.etc.ioc.POJO.ComponentAutowiredEtcComputer;
import jun.spring.etc.ioc.POJO.ComponentAutowiredQualifierComputer;
import jun.spring.etc.ioc.POJO.ConsolePrinter;
import jun.spring.etc.ioc.POJO.ManyPrinter1;
...
public class CH_1_2_3_BEAN_DEPENDENCY_3_ETC {
    ...
    public void AUTOWIRED_동일한_타입_2개_실패_테스트() {
        /**
         * No unique bean of type [jun.spring.etc.ioc.POJO.Printer] is defined:
